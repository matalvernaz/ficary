...
class OptionalFeaturesDialog(wx.Dialog):
    ...
    def _build_ui(self):
        ...
        header = wx.StaticText(
            panel,
            label=(
                "ficary ships a minimal core install. Optional features "
        ...
        if ok:
            ...
            if getattr(_sys, "frozen", False):
                wx.MessageBox(
                    ...
                    "Please restart ficary so the new package is "
...
class LlmSettingsDialog(wx.Dialog):
    ...
    # tasks ficary uses an LLM for (author's-note classification +
    ...
    _CURATED_MODELS = {
        ...
        "openai": [
            "gpt-4o-mini",       # cheap + fast, the default for ficary tasks
            "gpt-4o",
            "gpt-4-turbo",
        ],
        "anthropic": [
    ...
    def __init__(self, parent, prefs):
        ...
        # without an ficary update. Probe results merge in as the
        ...
        # 0 means "use the FICARY_LLM_TIMEOUT_S env var, then the
        ...
        self.timeout_ctrl.SetToolTip(
            ...
            "use the default (300s) or the FICARY_LLM_TIMEOUT_S env "
    ...
    def _confirm_close_during_pull(self) -> bool:
        ...
        visibility and a subsequent ficary exit will abort the
        ...
        choice = wx.MessageBox(
            ...
            "continues in the background, but quitting ficary "
