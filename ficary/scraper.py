...
class BaseScraper:
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        inside a fresh :func:`~ficary.logging_utils.correlation_context`.
        ...
        if fn is None or getattr(fn, "__ficary_cid_wrapped__", False):
            return
        ...
        wrapped.__ficary_cid_wrapped__ = True
        ...
        *,
        ...
        Args:
            ...
            chapter_spec: The ``--chapters`` range list, or ``None``
                ...
                :func:`~ficary.models.chapter_in_spec`.
        ...
        Returns:
            List of :class:`~ficary.models.Chapter` objects, ready to
    ...
    def cache_key_for_url(cls, url_or_id):
        ...
        this to mirror that hash so :mod:`ficary.cache_doctor` can
    ...
    def download(
        ...
        """Fetch and return a :class:`~ficary.models.Story` object.
