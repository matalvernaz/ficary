...
FFN throttles direct scraping hard: :class:`~ficary.scraper.FFNScraper`
...
downloads the EPUB it hands back, and re-ingests it into ficary's own
:class:`~ficary.models.Story` / :class:`~ficary.models.Chapter` model so
...
def _story_from_epub(
    ...
    *,
    ...
    try:
        ...
        logger.info(
            "FicHub fast-path needs ebooklib (pip install 'ficary[epub]'); "
